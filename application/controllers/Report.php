...
class Report extends CI_Controller {
    ...
    private function loop_through($cur_suites) {
        ...
        if (sizeof($suite->tests) > 0) {
            ...
            $this->suites_content .= '<div class="block_info"><i class="material-icons">assignment</i> <div class="info number_tests"> '.sizeof($suite->tests).'</div></div>';
            ...
            $this->suites_content .= '<div class="background"><div class="metric_number">'.(round($suite->totalPasses/sizeof($suite->tests), 3) * 100).'%</div><div class="advancement" style="width:'.(round($suite->totalPasses/sizeof($suite->tests), 3) * 100).'%"></div></div>';
